...
internal static class CorpusCompiler
{
	...
	private static IEnumerable<CorpusRow> LoadClinc(string path, int count, SourceDefinition definition)
	{
		using var document = JsonDocument.Parse(File.ReadAllText(path, Utf8));
		var rows = new List<CorpusRow>(count);
		var usedInputs = new HashSet<string>(StringComparer.Ordinal);
	...
	private static IEnumerable<CorpusRow> LoadOasst(string path, int count, SourceDefinition definition)
	{
	...
	private static IEnumerable<CorpusRow> LoadGoEmotions(string rawPath, int count, SourceDefinition definition)
	{
		var rows = new List<CorpusRow>(count);
		var usedInputs = new HashSet<string>(StringComparer.Ordinal);
	...
	private static IEnumerable<CorpusRow> LoadCivil(string path, int count, SourceDefinition definition)
	{
