# Legacy Fishbrain runtime

This document describes the preserved structured model. See README.md and CAUSAL_MODEL.md for the new causal runtime.
...
dotnet run -c Release --project Fishbrain.LegacyCli -- teach data/compiled-contextual data/training/contextual-training.fbm --planned 260000 --until 260000
```
...
dotnet run --no-build -c Release --project Fishbrain.LegacyCli -- teach data/compiled-contextual-v3 data/training/contextual-v3-training.fbm --planned 260000 --until 260000
```
...
```powershell
dotnet run --no-build -c Release --project Fishbrain.LegacyCli -- benchmark-training data/compiled-contextual-v3 data/training/contextual-v3-training.fbm data/training/speed-report.json 3
```
...
```powershell
dotnet run -c Release --project Fishbrain.LegacyCli -- export data/training/contextual-training.fbm data/training/candidate.fbm data/compiled-contextual
dotnet run -c Release --project Fishbrain.LegacyCli -- evaluate data/compiled-contextual/test.jsonl data/training/candidate.fbm --gate release
dotnet run -c Release --project Fishbrain.LegacyCli -- profile-contextual data/training/candidate.fbm 32
dotnet run -c Release --project Fishbrain.LegacyCli -- acceptance-contextual data/training/candidate.fbm data/logs/acceptance.json
dotnet run -c Release --project Fishbrain.LegacyCli -- compare-contextual data/compiled-contextual data/training/candidate.fbm data/logs/comparison.json
dotnet run -c Release --project Fishbrain.LegacyCli -- conversation-sample data/training/candidate.fbm data/benchmarks/conversation-scenarios.jsonl data/logs/conversation-sample.jsonl
```
